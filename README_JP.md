...
> 本プロジェクトの開発データ（継続更新中）：
>
> 開発期間：累計 58 日（メインプラグイン部分）
>
> 総作業時間：約 293 時間（メインプラグイン部分）
>
...
> [!NOTE]
>
> QQ 公式 Bot を使用する場合、個人 QQ アカウントのように QQ 番号を入力してはいけません。代わりに UID を入力してください。`/sid` コマンドで取得でき、形式は `1A2B3D4C5E6F9F8E7D6C5B4A321` のようになります。
>
...
>
> QQ 公式 Bot を利用する際は、個人 QQ アカウントのように QQ 番号を入力するのではなく UID を入力してください。`/sid` で取得でき、`1A2B3D4C5E6F9F8E7D6C5B4A` のような形式になります。
